...
function SolutionSection() {
  ...
  return (
    <section className="mt-52 mb-14 flex justify-center items-center container flex-col">
      <div className="bg-[#e5e5e5] md:w-[83%] md:h-[920px] hidden lg:block  solutions-radius   shadow-2xl relative">
        ...
        <div className="">
          ...
          <img
            data-aos="zoom-out"
            src={mainCharacter}
            className="absolute top-[-150px] left-20 hidden lg:block"
            alt="Main chatacter"
          />
      ...
      <div className=" w-full md:w-[85%] py-6 h-auto lg:h-[400px] block lg:hidden bg-[#e5e5e5]  mx-auto shadow-xl relative ">
        {/* Mobile Solutions text and image */}
        <div className="relative">
          <img
            src={mainCharacter}
            className="absolute w-52 md:w-80 bottom-[-100] md:top-[-300px] right-1 top-[-180px]  left-[50%] -translate-x-1/2"
            alt="main character"
          />
          ...
          <div className="flex flex-col items-center mt-20 py-3">
            ...
            <p className="w-[80%] text-justify text-base font-medium">
              We deliver cutting-edge custom software development, immersive
              game development, dynamic web development, and a full spectrum of
              IT solutions and services tailored to meet the unique needs of our
              clients.{" "}
        ...
        <div className="flex flex-col space-y-4 items-center rounded-md py-4">
          <div className="w-[90%] h-[200px] bg-muhoko-gradient  rounded-lg shadow-2xl flex flex-col justify-center items-center p-2">
            {" "}
            <img src={websites} className="w-[60px]" alt="character dev icon" />
            <h1 className="text-white text-base my-1">Web Development</h1>
            <p className="text-white text-justify text-base text-pretty w-[90%]">
              We specialize in creating custom websites that are visually
              appealing, highly functional, and optimized for performance.
            </p>
          </div>
          ...
          <div className="w-[90%] h-[200px] bg-muhoko-gradient  rounded-lg shadow-2xl flex flex-col justify-center items-center p-2">
            ...
            <img
              ...
              alt="character dev icon"
            />
            <h1 className="text-white text-base my-1 ">
              Software & App Development
            </h1>
            <p className="text-white text-justify text-base text-pretty w-[90%]">
          ...
          {/* Card 3 */}
          <div className="w-[90%] h-[230px] bg-muhoko-gradient  rounded-lg shadow-2xl flex flex-col justify-center items-center p-2">
            {" "}
            <img src={gameDev} className="w-[60px]" alt="character dev icon" />
            <h1 className="text-white text-base  my-1">Game Development</h1>
            <p className="text-white text-justify text-base text-pretty w-[90%]">
          ...
          <div className="w-[90%] h-[200px] bg-muhoko-gradient  rounded-lg shadow-2xl flex flex-col justify-center items-center p-2">
            ...
            <img
              ...
              alt="character dev icon"
            />
            <h1 className="text-white text-base my-1">Character Design</h1>
            <p className="text-white text-justify text-base text-pretty w-[90%]">
              We specialize in creating custom websites that are visually
              appealing, highly functional, and optimized for performance.
            </p>
