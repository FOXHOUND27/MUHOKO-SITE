  ...
  return (
    <nav className="py-4 w-full bg-custom-gradient shadow-xl fixed top-0 left-0">
      <div className="container h-full w-full md:flex md:justify-around md:items-center">
        ...
        {/* Navigation Items */}
        <ul
          className={`md:flex md:items-center md:text-lg text-white space-x-3 md:pb-0 pb-4 md:pt-0 pt-4 absolute md:static bg-[#242424] md:bg-transparent md:z-auto z-[-1] left-8 shadow-2xl rounded-lg w-[80%] md:w-auto text-center transition-all duration-500 ease-in ${
